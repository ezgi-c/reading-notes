...
Easier to manage applications due to having access to other AWS services inclugin database and storage.
...
- Users can focus on bulding apps without spending too much time configuring and managing infrastructure
- Automatic scaling
